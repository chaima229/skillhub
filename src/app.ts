...
import groupRoutes from "./modules/group/router/group.router";
import projectRoutes from "./modules/project/router/project.router";
import projectAssignmentRoutes from "./modules/projectAssignment/router/projectAssignment.router";
import competenceRoutes from "./modules/competence/router/competence.router";
import competenceOnProjectRoutes from "./modules/competenceOnProject/router/competenceOnProject.router";
import evaluationCriteriaRoutes from "./modules/evaluationCriteria/router/evaluationCriteria.router";
import submissionRoutes from "./modules/submission/router/submission.router";
import resourceRoutes from "./modules/resource/router/resource.router";
import notificationRoutes from "./modules/notification/router/notification.router";
